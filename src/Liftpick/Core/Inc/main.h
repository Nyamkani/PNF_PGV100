...
/* Private defines -----------------------------------------------------------*/
#define DI18_Pin LL_GPIO_PIN_2
#define DI18_GPIO_Port GPIOE
#define DI19_Pin LL_GPIO_PIN_3
#define DI19_GPIO_Port GPIOE
#define DI20_Pin LL_GPIO_PIN_4
#define DI20_GPIO_Port GPIOE
#define DI_EMG1_Pin LL_GPIO_PIN_5
#define DI_EMG1_GPIO_Port GPIOE
#define DI_EMG2_Pin LL_GPIO_PIN_6
#define DI_EMG2_GPIO_Port GPIOE
#define MCX512_INT0_Pin LL_GPIO_PIN_14
#define MCX512_INT0_GPIO_Port GPIOC
#define MCX512_INT1_Pin LL_GPIO_PIN_15
#define MCX512_INT1_GPIO_Port GPIOC
#define CO1_Pin LL_GPIO_PIN_4
#define CO1_GPIO_Port GPIOF
#define CO2_Pin LL_GPIO_PIN_5
#define CO2_GPIO_Port GPIOF
#define LED1_R_Pin LL_GPIO_PIN_6
#define LED1_R_GPIO_Port GPIOF
#define LED1_G_Pin LL_GPIO_PIN_7
#define LED1_G_GPIO_Port GPIOF
#define LED1_B_Pin LL_GPIO_PIN_8
#define LED1_B_GPIO_Port GPIOF
#define LED2_R_Pin LL_GPIO_PIN_9
#define LED2_R_GPIO_Port GPIOF
#define LED2_G_Pin LL_GPIO_PIN_10
#define LED2_G_GPIO_Port GPIOF
#define UART5_DIR_Pin LL_GPIO_PIN_0
#define UART5_DIR_GPIO_Port GPIOB
#define UART6_DIR_Pin LL_GPIO_PIN_1
#define UART6_DIR_GPIO_Port GPIOB
#define UART4_DIR_Pin LL_GPIO_PIN_2
#define UART4_DIR_GPIO_Port GPIOB
#define LED2_B_Pin LL_GPIO_PIN_11
#define LED2_B_GPIO_Port GPIOF
#define DO1_Pin LL_GPIO_PIN_12
#define DO1_GPIO_Port GPIOF
#define DO2_Pin LL_GPIO_PIN_13
#define DO2_GPIO_Port GPIOF
#define DO3_Pin LL_GPIO_PIN_14
#define DO3_GPIO_Port GPIOF
#define DO4_Pin LL_GPIO_PIN_15
...
#define MCX512_RST_Pin LL_GPIO_PIN_8
#define MCX512_RST_GPIO_Port GPIOC
#define MCX512_EMG_Pin LL_GPIO_PIN_9
...
#define DI12_Pin LL_GPIO_PIN_12
#define DI12_GPIO_Port GPIOG
#define DI13_Pin LL_GPIO_PIN_13
#define DI13_GPIO_Port GPIOG
#define DI14_Pin LL_GPIO_PIN_14
#define DI14_GPIO_Port GPIOG
#define DI15_Pin LL_GPIO_PIN_15
#define DI15_GPIO_Port GPIOG
#define BUZZER_Pin LL_GPIO_PIN_5
#define BUZZER_GPIO_Port GPIOB
#define SLED1_Pin LL_GPIO_PIN_6
#define SLED1_GPIO_Port GPIOB
#define SLED2_Pin LL_GPIO_PIN_7
#define SLED2_GPIO_Port GPIOB
#define SLED3_Pin LL_GPIO_PIN_8
#define SLED3_GPIO_Port GPIOB
#define SLED4_Pin LL_GPIO_PIN_9
#define SLED4_GPIO_Port GPIOB
#define DI16_Pin LL_GPIO_PIN_0
#define DI16_GPIO_Port GPIOE
#define DI17_Pin LL_GPIO_PIN_1
